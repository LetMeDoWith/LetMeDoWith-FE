...
const FeedIcon = ({
  ...
  height = 22,
  fill = 'none',
  fillRect = theme.COLORS.GRAY_SCALE.GRAY_80,
  stroke = theme.COLORS.GRAY_SCALE.GRAY_80,
  ...
  return (
    <Svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill={fill}>
      <Path
        ...
        stroke={stroke}
      />
      <Rect x="4.81055" y="3.20703" width="2.138" height="6.414" rx="1.069" fill={theme.COLORS.DEFAULT.WHITE} />
      <Rect x="10.1558" y="3.20703" width="2.138" height="6.414" rx="1.069" fill={theme.COLORS.DEFAULT.WHITE} />
    </Svg>
  );
};
