...
import type {
  ...
  fetchDowithTaskResponseDataSchemeType,
...
const useFetchDowithTask = (
  ...
  options?: Omit<
    UseQueryOptions<fetchDowithTaskResponseSchemeType, ApiError, fetchDowithTaskResponseDataSchemeType>,
    'queryKey' | 'queryFn'
  >,
) =>
  useQuery<fetchDowithTaskResponseSchemeType, ApiError, fetchDowithTaskResponseDataSchemeType>({
